              ...
              child: new Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: Padding(
                      padding:
                          const EdgeInsets.fromLTRB(30.0, 75.0, 30.0, 10.0),
                      child: GestureDetector(
                        ...
                        child: new Container(
                            ...
                            child: new CustomText('Start Quiz',
                                fontSize: 50.0,
                                color: const Color(0xfffffffa))),
                      ),
                    ),
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      ...
                      child: new Container(
                          ...
                          child: new CustomText('Setting',
                              fontSize: 50.0, color: const Color(0xfffffffa))),
                    ),
                  ))
                ],
              ),
